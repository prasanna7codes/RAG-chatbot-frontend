(function () {
  ...
  iframe.src = `http://localhost:5173/chatbot?apiKey=${apiKey}&clientDomain=${encodeURIComponent(clientDomain)}&themeColor=${encodeURIComponent(themeColor)}&botName=${encodeURIComponent(botName)}`;
